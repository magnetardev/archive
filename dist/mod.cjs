...
var parcelRequire = $parcel$global["parcelRequireb941"];
if (parcelRequire == null) {
  ...
  $parcel$global["parcelRequireb941"] = parcelRequire;
}

$parcel$export(module.exports, "createReader", () => $5e2f01247a5d6f10$export$3687857846e34983);
$parcel$export(module.exports, "createWriter", () => $5e2f01247a5d6f10$export$52c63a46d288b169);
$parcel$export(module.exports, "fileTypes", () => $ba7b8166ab76736c$exports);
$parcel$export(module.exports, "perms", () => $6ddba6f423cf59ca$exports);
var $09e3bf25bb2011e2$exports = {};

$parcel$export($09e3bf25bb2011e2$exports, "default", () => $09e3bf25bb2011e2$export$2e2bcd8739ae039, (v) => $09e3bf25bb2011e2$export$2e2bcd8739ae039 = v);
var $09e3bf25bb2011e2$var$__dirname = "src";
parcelRequire.register("b8tjw", function(module, exports) {
"use strict";

});


var $b8tjw = parcelRequire("b8tjw");
var $09e3bf25bb2011e2$require$Buffer = $b8tjw.Buffer;
...
var $09e3bf25bb2011e2$export$2e2bcd8739ae039 = (config)=>new Promise((resolve1, reject1)=>{
        ...
        var ENVIRONMENT_IS_NODE = typeof $b8tjw === "object" && typeof $b8tjw.versions === "object" && typeof $b8tjw.versions.node === "string";
        var scriptDirectory = "";
        ...
        if (ENVIRONMENT_IS_NODE) {
            if (ENVIRONMENT_IS_WORKER) scriptDirectory = (parcelRequire("b8tjw")).dirname(scriptDirectory) + "/";
            else scriptDirectory = $09e3bf25bb2011e2$var$__dirname + "/";
            requireNodeFS = function() {
                if (!nodePath) {
                    fs = (parcelRequire("b8tjw"));
                    nodePath = (parcelRequire("b8tjw"));
                }
            };
            ...
            if ($b8tjw["argv"].length > 1) thisProgram = $b8tjw["argv"][1].replace(/\\/g, "/");
            arguments_ = $b8tjw["argv"].slice(2);
            if ("object" !== "undefined") $09e3bf25bb2011e2$exports = Module;
            $b8tjw["on"]("uncaughtException", function(ex) {
                if (!(ex instanceof ExitStatus)) throw ex;
            });
            $b8tjw["on"]("unhandledRejection", function(reason) {
                throw reason;
            });
            quit_ = (status, toThrow)=>{
                if (keepRuntimeAlive()) {
                    $b8tjw["exitCode"] = status;
                    throw toThrow;
                }
        ...
        function getRandomDevice() {
            if (typeof crypto === "object" && typeof crypto["getRandomValues"] === "function") {
                ...
                var crypto_module = (parcelRequire("b8tjw"));
                return function() {
            ...
            default_tty_ops: {
                get_char: function(tty) {
                    if (!tty.input.length) {
                        ...
                        if (ENVIRONMENT_IS_NODE) {
                            var BUFSIZE = 256;
                            var buf = $09e3bf25bb2011e2$require$Buffer.alloc(BUFSIZE);
                            var bytesRead = 0;
                            try {
                                bytesRead = fs.readSync($b8tjw.stdin.fd, buf, 0, BUFSIZE, null);
                            } catch (e) {
            ...
            stream_ops: {
                poll: function(stream) {
                    ...
                    if ((stream.flags & 2097155) === 1) return 260;
                        ...
                        if (pipe.buckets.length > 0) for(var i = 0; i < pipe.buckets.length; i++){
        ...
        function _ctime_r(time, buf) {
            return withStackSave(function() {
                return ___asctime_r(_localtime_r(time, stackAlloc(44)), buf);
            });
        }
        ...
        var asmLibraryArg = {
            ...
            "n": ___syscall_getgid32,
            "m": ___syscall_getuid32,
        ...
        var _archive_read_memory = Module["_archive_read_memory"] = function() {
            return (_archive_read_memory = Module["_archive_read_memory"] = Module["asm"]["I"]).apply(null, arguments);
        };
        var _archive_read_next_entry = Module["_archive_read_next_entry"] = function() {
            return (_archive_read_next_entry = Module["_archive_read_next_entry"] = Module["asm"]["J"]).apply(null, arguments);
        };
        var _archive_write_memory = Module["_archive_write_memory"] = function() {
            return (_archive_write_memory = Module["_archive_write_memory"] = Module["asm"]["K"]).apply(null, arguments);
        };
        var _archive_write_memory_close = Module["_archive_write_memory_close"] = function() {
            return (_archive_write_memory_close = Module["_archive_write_memory_close"] = Module["asm"]["L"]).apply(null, arguments);
        };
        var _archive_write_entry = Module["_archive_write_entry"] = function() {
            return (_archive_write_entry = Module["_archive_write_entry"] = Module["asm"]["M"]).apply(null, arguments);
        };
...
async function $89b863265ea3ba99$export$2e2bcd8739ae039(options = {
}) {
    const mod = await $09e3bf25bb2011e2$exports.default({
        locateFile (path, prefix) {
            if (path === "archive.wasm") return new URL("archive.871f2dc2.wasm", "file:" + __filename).href;
            return prefix + path;
        },
        ...options
    });
    return {
        ...
        read_next_entry: mod.cwrap("archive_read_next_entry", "number", [
            "number"
        ]),
        read_has_encrypted_entries: mod.cwrap("archive_read_has_encrypted_entries", "number", [
            "number"
        ]),
        ...
        read_data_skip: mod.cwrap("archive_read_data_skip", "number", [
            "number"
        ]),
        read_free: mod.cwrap("archive_read_free", "number", [
            "number"
        ]),
        // Entry methods
        entry_filetype: mod.cwrap("archive_entry_filetype", "number", [
            "number"
        ]),
        entry_pathname: mod.cwrap("archive_entry_pathname_utf8", "string", [
            "number", 
        ]),
        entry_size: mod.cwrap("archive_entry_size", "number", [
            "number"
        ]),
        ...
        write_close: mod.cwrap("archive_write_memory_close", null, [
            "number"
        ]),
...
var $ba7b8166ab76736c$exports = {};

$parcel$export($ba7b8166ab76736c$exports, "FileType", () => $ba7b8166ab76736c$export$c5ae10d7c88c4d3e);
$parcel$export($ba7b8166ab76736c$exports, "FileTypeMap", () => $ba7b8166ab76736c$export$413fb8502ce63cf9);
var $ba7b8166ab76736c$export$c5ae10d7c88c4d3e;
(function(FileType) {
...
})($ba7b8166ab76736c$export$c5ae10d7c88c4d3e || ($ba7b8166ab76736c$export$c5ae10d7c88c4d3e = {
}));
const $ba7b8166ab76736c$export$413fb8502ce63cf9 = new Map([
    [
        $ba7b8166ab76736c$export$c5ae10d7c88c4d3e.Mount,
        "Mount"
    ],
    [
        $ba7b8166ab76736c$export$c5ae10d7c88c4d3e.File,
        "File"
    ],
    [
        $ba7b8166ab76736c$export$c5ae10d7c88c4d3e.Symlink,
        "Symlink"
    ],
    [
        $ba7b8166ab76736c$export$c5ae10d7c88c4d3e.Socket,
        "Socket"
    ],
    [
        $ba7b8166ab76736c$export$c5ae10d7c88c4d3e.CharacterDevice,
        "CharacterDevice"
    ],
    [
        $ba7b8166ab76736c$export$c5ae10d7c88c4d3e.BlockDevice,
        "BlockDevice"
    ],
    [
        $ba7b8166ab76736c$export$c5ae10d7c88c4d3e.Directory,
        "Directory"
    ],
    [
        $ba7b8166ab76736c$export$c5ae10d7c88c4d3e.NamedPipe,
        "NamedPipe"
    ], 
]);


class $9bfed2ab7787d0fa$export$5edc3959ad1c0771 {
    ...
    next() {
        ...
        return new $9bfed2ab7787d0fa$var$ArchiveEntry(this, entryPtr, this.archive);
    }
    *entries() {
        for(;;){
...
class $9bfed2ab7787d0fa$var$ArchiveEntry {
    ...
    get filetype() {
        ...
        return $ba7b8166ab76736c$export$413fb8502ce63cf9.get(this.reader.api.entry_filetype(this.ptr)) ?? "Invalid";
    }
    get path() {
        if (!this.reader || !this.ptr) throw new Error("ERR_NO_READER");
    ...
    extract() {
        if (!this.reader || !this.ptr || !this.archive) throw new Error("ERR_NO_READER");
...
var $6ddba6f423cf59ca$exports = {};

$parcel$export($6ddba6f423cf59ca$exports, "FilePerm", () => $6ddba6f423cf59ca$export$603385cfed9cb15c);
$parcel$export($6ddba6f423cf59ca$exports, "filePerm", () => $6ddba6f423cf59ca$export$6be1d7fb30145e7d);
$parcel$export($6ddba6f423cf59ca$exports, "permString", () => $6ddba6f423cf59ca$export$584e7c4f1c432a6f);
var $6ddba6f423cf59ca$export$603385cfed9cb15c;
(function(FilePerm) {
...
})($6ddba6f423cf59ca$export$603385cfed9cb15c || ($6ddba6f423cf59ca$export$603385cfed9cb15c = {
}));
const $6ddba6f423cf59ca$export$6be1d7fb30145e7d = (user, group, other)=>0 | user << 6 | group << 3 | other
;
const $6ddba6f423cf59ca$export$584e7c4f1c432a6f = (perm)=>[
        // user
        perm & 256 ? "r" : "-",
        perm & 128 ? "w" : "-",
        perm & 64 ? "x" : "-",
...
const $6af868a4bfd93a94$export$dff1b9e2483331c2 = {
    cpio: 65536,
    cpio_posix: 65537,
    cpio_bin_le: 65538,
...
let $6af868a4bfd93a94$var$archiveID = 0;
class $6af868a4bfd93a94$export$141d3123b5ee533d {
    constructor(api, type){
        this.api = api;
        const format = $6af868a4bfd93a94$export$dff1b9e2483331c2[type];
        this.fileName = `archive_${$6af868a4bfd93a94$var$archiveID++}.tmp`;
        this.archive = api.write_memory(this.fileName, format);
    }
    add(path, buffer, type1 = $ba7b8166ab76736c$export$c5ae10d7c88c4d3e.File, perm = 511) {
        if (!this.archive) throw new Error("ERR_NO_ARCHIVE");
        const ptr = this.api.mod._malloc(buffer.length);
        this.api.mod.HEAPU8.set(buffer, ptr);
        this.api.write_entry(this.archive, path, type1, perm, ptr, buffer.length);
    }
    close() {
        if (!this.archive) throw new Error("ERR_NO_ARCHIVE");
...
/** A cache of sorts for the create fucntions. */ let $5e2f01247a5d6f10$var$mod;
async function $5e2f01247a5d6f10$export$3687857846e34983(archive, options) {
    if (!$5e2f01247a5d6f10$var$mod) $5e2f01247a5d6f10$var$mod = await $89b863265ea3ba99$export$2e2bcd8739ae039({
        locateFile: options?.locateFile
    });
    return new $9bfed2ab7787d0fa$export$5edc3959ad1c0771($5e2f01247a5d6f10$var$mod, new Uint8Array(archive), options?.password);
}
async function $5e2f01247a5d6f10$export$52c63a46d288b169(type = "zip", options) {
    if (!$5e2f01247a5d6f10$var$mod) $5e2f01247a5d6f10$var$mod = await $89b863265ea3ba99$export$2e2bcd8739ae039(options);
    return new $6af868a4bfd93a94$export$141d3123b5ee533d($5e2f01247a5d6f10$var$mod, type);
}
