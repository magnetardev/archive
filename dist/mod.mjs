...
var $0ef0787dc4ba7936$exports = {};

$parcel$export($0ef0787dc4ba7936$exports, "default", () => $0ef0787dc4ba7936$export$2e2bcd8739ae039, (v) => $0ef0787dc4ba7936$export$2e2bcd8739ae039 = v);
parcelRequire.register("7KeRE", function(module, exports) {
"use strict";

});


var $7KeRE = parcelRequire("7KeRE");
var $0ef0787dc4ba7936$var$__dirname = "src";

var $7KeRE = parcelRequire("7KeRE");
var $0ef0787dc4ba7936$require$Buffer = $7KeRE.Buffer;




var $0ef0787dc4ba7936$export$2e2bcd8739ae039 = (config)=>new Promise((resolve1, reject1)=>{
        ...
        var ENVIRONMENT_IS_NODE = typeof $7KeRE === "object" && typeof $7KeRE.versions === "object" && typeof $7KeRE.versions.node === "string";
        var scriptDirectory = "";
        ...
        if (ENVIRONMENT_IS_NODE) {
            if (ENVIRONMENT_IS_WORKER) scriptDirectory = (parcelRequire("7KeRE")).dirname(scriptDirectory) + "/";
            else scriptDirectory = $0ef0787dc4ba7936$var$__dirname + "/";
            requireNodeFS = function() {
                if (!nodePath) {
                    fs = (parcelRequire("7KeRE"));
                    nodePath = (parcelRequire("7KeRE"));
                }
            };
            ...
            if ($7KeRE["argv"].length > 1) thisProgram = $7KeRE["argv"][1].replace(/\\/g, "/");
            arguments_ = $7KeRE["argv"].slice(2);
            if ("object" !== "undefined") $0ef0787dc4ba7936$exports = Module;
            $7KeRE["on"]("uncaughtException", function(ex) {
                if (!(ex instanceof ExitStatus)) throw ex;
            });
            $7KeRE["on"]("unhandledRejection", function(reason) {
                throw reason;
            });
            quit_ = (status, toThrow)=>{
                if (keepRuntimeAlive()) {
                    $7KeRE["exitCode"] = status;
                    throw toThrow;
                }
        ...
        function getRandomDevice() {
            if (typeof crypto === "object" && typeof crypto["getRandomValues"] === "function") {
                ...
                var crypto_module = (parcelRequire("7KeRE"));
                return function() {
            ...
            default_tty_ops: {
                get_char: function(tty) {
                    if (!tty.input.length) {
                        ...
                        if (ENVIRONMENT_IS_NODE) {
                            var BUFSIZE = 256;
                            var buf = $0ef0787dc4ba7936$require$Buffer.alloc(BUFSIZE);
                            var bytesRead = 0;
                            try {
                                bytesRead = fs.readSync($7KeRE.stdin.fd, buf, 0, BUFSIZE, null);
                            } catch (e) {
...
async function $7afcfa1aabf33948$export$2e2bcd8739ae039(options = {
}) {
    const mod = await $0ef0787dc4ba7936$exports.default({
        locateFile (path, prefix) {
            if (path === "archive.wasm") return new URL("archive.e1a0f18d.wasm", import.meta.url).href;
            return prefix + path;
        },
        ...options
    });
...
var $86e3a31cdc342703$exports = {};

$parcel$export($86e3a31cdc342703$exports, "FileType", () => $86e3a31cdc342703$export$c5ae10d7c88c4d3e);
$parcel$export($86e3a31cdc342703$exports, "FileTypeMap", () => $86e3a31cdc342703$export$413fb8502ce63cf9);
var $86e3a31cdc342703$export$c5ae10d7c88c4d3e;
(function(FileType) {
...
})($86e3a31cdc342703$export$c5ae10d7c88c4d3e || ($86e3a31cdc342703$export$c5ae10d7c88c4d3e = {
}));
const $86e3a31cdc342703$export$413fb8502ce63cf9 = new Map([
    [
        $86e3a31cdc342703$export$c5ae10d7c88c4d3e.Mount,
        "Mount"
    ],
    [
        $86e3a31cdc342703$export$c5ae10d7c88c4d3e.File,
        "File"
    ],
    [
        $86e3a31cdc342703$export$c5ae10d7c88c4d3e.Symlink,
        "Symlink"
    ],
    [
        $86e3a31cdc342703$export$c5ae10d7c88c4d3e.Socket,
        "Socket"
    ],
    [
        $86e3a31cdc342703$export$c5ae10d7c88c4d3e.CharacterDevice,
        "CharacterDevice"
    ],
    [
        $86e3a31cdc342703$export$c5ae10d7c88c4d3e.BlockDevice,
        "BlockDevice"
    ],
    [
        $86e3a31cdc342703$export$c5ae10d7c88c4d3e.Directory,
        "Directory"
    ],
    [
        $86e3a31cdc342703$export$c5ae10d7c88c4d3e.NamedPipe,
        "NamedPipe"
    ], 
]);


class $41ea6c2df718ee7d$export$5edc3959ad1c0771 {
    ...
    next() {
        ...
        return new $41ea6c2df718ee7d$var$ArchiveEntry(this, entryPtr, this.archive);
    }
    *entries() {
        for(;;){
...
class $41ea6c2df718ee7d$var$ArchiveEntry {
    ...
    get filetype() {
        ...
        return $86e3a31cdc342703$export$413fb8502ce63cf9.get(this.reader.api.entry_filetype(this.ptr)) ?? "Invalid";
    }
    get path() {
        if (!this.reader || !this.ptr) throw new Error("ERR_NO_READER");
...
var $36461b56dd348ffc$exports = {};

$parcel$export($36461b56dd348ffc$exports, "FilePerm", () => $36461b56dd348ffc$export$603385cfed9cb15c);
$parcel$export($36461b56dd348ffc$exports, "filePerm", () => $36461b56dd348ffc$export$6be1d7fb30145e7d);
$parcel$export($36461b56dd348ffc$exports, "permString", () => $36461b56dd348ffc$export$584e7c4f1c432a6f);
var $36461b56dd348ffc$export$603385cfed9cb15c;
(function(FilePerm) {
...
})($36461b56dd348ffc$export$603385cfed9cb15c || ($36461b56dd348ffc$export$603385cfed9cb15c = {
}));
const $36461b56dd348ffc$export$6be1d7fb30145e7d = (user, group, other)=>0 | user << 6 | group << 3 | other
;
const $36461b56dd348ffc$export$584e7c4f1c432a6f = (perm)=>[
        // user
        perm & 256 ? "r" : "-",
        perm & 128 ? "w" : "-",
        perm & 64 ? "x" : "-",
...
const $9ea3819be21dd32a$export$dff1b9e2483331c2 = {
    cpio: 65536,
    cpio_posix: 65537,
    cpio_bin_le: 65538,
...
let $9ea3819be21dd32a$var$archiveID = 0;
class $9ea3819be21dd32a$export$141d3123b5ee533d {
    constructor(api, type){
        this.api = api;
        const format = $9ea3819be21dd32a$export$dff1b9e2483331c2[type];
        this.fileName = `archive_${$9ea3819be21dd32a$var$archiveID++}.tmp`;
        this.archive = api.write_memory(this.fileName, format);
    }
    add(path, buffer, type1 = $86e3a31cdc342703$export$c5ae10d7c88c4d3e.File, perm = 511) {
        if (!this.archive) throw new Error("ERR_NO_ARCHIVE");
...
/** A cache of sorts for the create fucntions. */ let $a8e101027d325e52$var$mod;
async function $a8e101027d325e52$export$3687857846e34983(archive, options) {
    if (!$a8e101027d325e52$var$mod) $a8e101027d325e52$var$mod = await $7afcfa1aabf33948$export$2e2bcd8739ae039({
        locateFile: options?.locateFile
    });
    return new $41ea6c2df718ee7d$export$5edc3959ad1c0771($a8e101027d325e52$var$mod, new Uint8Array(archive), options?.password);
}
async function $a8e101027d325e52$export$52c63a46d288b169(type = "zip", options) {
    if (!$a8e101027d325e52$var$mod) $a8e101027d325e52$var$mod = await $7afcfa1aabf33948$export$2e2bcd8739ae039(options);
    return new $9ea3819be21dd32a$export$141d3123b5ee533d($a8e101027d325e52$var$mod, type);
}


export {$a8e101027d325e52$export$3687857846e34983 as createReader, $a8e101027d325e52$export$52c63a46d288b169 as createWriter};
